...
export const DEFAULT_MODELS = [
  {
    ...
    name: 'GPT-4o mini',
    description: 'Fast and cheap — good default for everyday questions',
    featured: false,
    default: true,
  },
  {
    ...
    description: 'High quality, large context — best for hard tasks',
    featured: true,
    default: false,
  },
  {
    ...
    description: 'Very fast, strong at long pages',
    featured: false,
    default: false,
  },
  {
    ...
    name: 'Llama 3.3 70B',
    description: 'Open-weight, solid all-rounder',
    featured: false,
    default: false,
  },
];
