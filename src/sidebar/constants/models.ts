...
export const MODELS: ModelDefinition[] = [
  { key: 'webllm-gemma', name: 'Gemma 2', params: '2B', size: '2.5 Gb', icon: '💎', desc: 'Balanced and smart' },
  { key: 'webllm-hermes', name: 'Hermes 3', params: '3B', size: '2.9 Gb', icon: '🎯', desc: 'Excellent instruction-following', recommended: true },
